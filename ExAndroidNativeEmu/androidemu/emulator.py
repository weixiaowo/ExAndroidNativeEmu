...
class Emulator:
    ...
    def __add_classes(self):
        ...
        package_name = "ExAndroidNativeEmu.androidemu"
        preload_classes = set()
    ...
    def __init__(self, vfs_root="vfs", config_path="emu_cfg/default.json", vfp_inst_set=True, arch=emu_const.ARCH_ARM32,
                 muti_task=False):
        # Unicorn.
        ...
        if arch == emu_const.ARCH_ARM32:
            self.system_properties = {"libc.debug.malloc.options": "", "ro.build.version.sdk": "19",
                                      "ro.build.version.release": "4.4.4", "persist.sys.dalvik.vm.lib": "libdvm.so",
                                      "ro.product.cpu.abi": "armeabi-v7a", "ro.product.cpu.abi2": "armeabi",
                                      "ro.product.manufacturer": "LGE", "ro.product.manufacturer": "LGE",
                                      "ro.debuggable": "0", "ro.product.model": "AOSP on HammerHead",
                                      "ro.hardware": "hammerhead", "ro.product.board": "hammerhead",
        ...
        #
            ...
            # Android 6.0
            self.system_properties = {"libc.debug.malloc.options": "", "ro.build.version.sdk": "23",
                                      "ro.build.version.release": "6.0.1", "persist.sys.dalvik.vm.lib2": "libart.so",
        ...
        # Hooker
        self.memory.map(config.BRIDGE_MEMORY_BASE, config.BRIDGE_MEMORY_SIZE,
